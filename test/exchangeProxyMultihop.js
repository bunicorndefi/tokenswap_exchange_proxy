...
describe('ExchangeProxyMultihop', async () => {
        ...
        const swapSequences = [
            ...
            [
                ...
                [
                    ...
                    MKR,
                    DAI,
                    //toWei(pool2Out.toString()), // This conversion t is bugged, so using hardcoded line below
        ...
        const swapSequences = [
            ...
            [
                [
                    ...
                    WETH,
                    MKR,
                    // toWei(pool3In.toString()), // This conversion t is bugged, so using hardcoded line below
        ...
        const swapSequences = [
            ...
            [
                ...
                [
                    ...
                    MKR,
                    WETH,
                    // toWei(pool2Out.toString()), // Error: [ethjs-unit] while converting number 0.23809501133785768275 to wei, too decimal places
        ...
        const swapSequences = [
            ...
            [
                [
                    ...
                    DAI,
                    MKR,
                    // toWei(pool2In.toString()), // Error: [ethjs-unit] while converting number 0.10818521496413451873 to wei, too decimal places
                    // toWei('0.108185215'),
                    toWei('0'), // This number should not influence the result
                    MAX,
                    MAX,
